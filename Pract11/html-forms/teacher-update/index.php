    ...
    <div class="container" style="min-height:700px;">
        <div class="table-responsive" style="background-color:#00000088; padding: 10px 0px;">
            ...
            function ConsultID($id)
            {
                ...
                $consult = "SELECT * FROM teachers WHERE IDteacher = '" . $id . "'";
            ...
            <form action="../../php-db/teacher-update.php" method="post" class="form-text text-white w-100 text-center">
                ...
                <table class="w-100 justify-content-center">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="Surname" id="Surname" value="<?php echo $ref[3] ?>" required><br>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <input type="text" name="MotherSurname" id="MotherSurname" value="<?php echo $ref[2] ?>" required><br>
                            </td>
                        </tr>
                        <tr>
                            <td><label for="adress">Dirección:</label></td>
                            <td><input type="text" name="Adress" id="Adress" value="<?php echo $ref[4]; ?>" required><br></td>
                        </tr>
                        <tr>
                            <td><label for="email">Email:</label></td>
                            <td><input type="text" name="Email" id="Email" value="<?php echo $ref[5]; ?>" required><br>
                            </td>
                        </tr>
                        <tr>
                            <td><label for="celphone">Telefono:</label></td>
                            <td><input type="text" name="Cellphone" id="Cellphone" value="<?php echo $ref[6]; ?>" required><br></td>
                        </tr>
                    </tbody>
                </table><br>
                <button type="submit" class="btn btn-success">Guardar cambios</button>
                <a href="../../php/teachers/" class="btn btn-danger">Cancelar</a>
            </form>
