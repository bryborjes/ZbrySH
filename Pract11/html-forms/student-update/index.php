    ...
    <div class="container" style="min-height:700px;">
        <div class="table-responsive" style="background-color:#00000088; padding: 10px 0px;">
            ...
            function ConsultID($id)
            {
                ...
                $consult = "SELECT * FROM student WHERE IDcontrol = '" . $id . "'";
            ...
            <form action="../../php-db/student-update.php" method="post" class="form-text text-white w-100 text-center">
                <input type="hidden" name="mat" value="<?php echo $_GET['mat'] ?> ">
                <!--<label for="id">ID:</label>
                    <input type="text" name="id" id="id" value="<//?php echo $ref[0]; ?>" required><br>-->
                <table class="w-100 justify-content-center">
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <input type="text" name="name" id="name" value="<?php echo $ref[1]; ?>" required><br>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <input type="text" name="Surname" id="Surname" value="<?php echo $ref[2] ?>" required><br>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <input type="text" name="MotherSurname" id="MotherSurname" value="<?php echo $ref[3] ?>" required><br>
                            </td>
                        </tr>
                        <tr>
                            <td><label for="adress">Semestre:</label></td>
                            <td><input type="text" name="Semester" id="Semester" value="<?php echo $ref[4]; ?>" required><br></td>
                        </tr>
                        <tr>
                            <td><label for="email">Grupo:</label></td>
                            <td><input type="text" name="Cluster" id="Clsuter" value="<?php echo $ref[5]; ?>" required><br>
                            </td>
                        </tr>
                        <tr>
                            <td><label for="celphone">Especialidad:</label></td>
                            <td><input type="text" name="Specialty" id="Specialty" value="<?php echo $ref[6]; ?>" required><br></td>
                        </tr>
                    </tbody>
                </table><br>
                <button type="submit" class="btn btn-success">Guardar cambios</button>
                <a href="../../php/students/" class="btn btn-danger">Cancelar</a>
            </form>
