...
$cluster = ucwords(strtolower($_POST['Cluster']));
$specialty = ucwords(strtolower($_POST['Specialty']));

// Construir la consulta SQL para actualizar los datos
$sql = "UPDATE `student` SET `Name` = '$name', `LastName` = '$surname', `MotherSurname` = '$mothersurname', 
`Semester` = '$semester', `Cluster` = '$cluster', `Specialty` = '$specialty' WHERE `student`.`IDcontrol` = $id";
