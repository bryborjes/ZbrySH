...
$sql = "INSERT INTO `teachers` (`IDteacher`, `Name`, `LastName`, `MotherSurname`, `Adress`, `Email`, `Cellphone`)
 VALUES (NULL, '$name', '$surname', '$mothersurname', '$adress', '$email', '$cellphone')";

// Ejecutar la consulta SQL
if (mysqli_query($conection, $sql)) {
    echo "
    <script type='text/JavaScript'>
        alert('Profesor(a) agregado(a) exitosamente');
