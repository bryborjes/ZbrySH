...
$sql = "INSERT INTO `student` (`IDcontrol`, `Name`, `LastName`, `MotherSurname`, `Semester`, `Cluster`, `Specialty`)
 VALUES (NULL, '$name', '$surname', '$mothersurname', '$semester', '$cluster', '$specialty')";
