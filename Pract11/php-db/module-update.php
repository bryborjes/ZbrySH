...
$id = $_POST['mat'];
$name = ucwords(strtolower($_POST['Module']));
$time = ($_POST['Hours']);
$credits = $_POST['Credits'];
// Construir la consulta SQL para actualizar los datos
$sql = "UPDATE `modules` SET `NameModule` = '$name', `Hours` = '$time', `Credits` = '$credits' WHERE `modules`.`CodeModule` = $id";
...
if (mysqli_query($conection, $sql)) {
    ...
    <script type='text/JavaScript'>
        ...
        window.location.href='../php/modules/';
    </script>";
}
else {
    echo "
