    ...
    <nav class="navbar navbar-expand-lg navbar-dark" style="background-image: linear-gradient(to bottom, #000000, #0000003b);">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <div class="menuSecionIniciada nav-item dropdown active">
                    ...
                    <div class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarDropdown" style="background-color: #00000085;">
                        ...
                        <a class="dropdown-item" href="">Maestros registrados</a>
                        <a class="dropdown-item" href="../modules/">Modulos impartidos</a>
                        <a class="dropdown-item" href="../students/">Alumnos inscritos</a>
            ...
            <table class="text-center table w-100 border-black">
                <thead class="border-1 bg-info text-white" id="headtable">
                    <tr>
                        ...
                        <th class="border-1">Autenticación</th>
                        <th class="border-1">Nombre</th>
                        <th class="border-1">Nombre de usuario</th>
                        <th class="border-1">Email</th>
                        <th class="border-1">Contraseña</th>
                        <th class="border-1">Tipo de usuario</th>
                        <th class="border-1" colspan="2">
                        <a href="../../html-forms/user-insert-default/" class="btn btn-light">Agregar nuevo</a>
                        </th>
                    </tr>
                </thead>
                <tbody class="bg-info-subtle">
                    ...
                    if (!$result) {
                        ...
                        while ($colum = mysqli_fetch_array($result)) {
                            echo "<tr>";
                            echo "<td class='border-1'>" . $colum['ID'] . "</td>";
                            echo "<td class='border-1'>" . $colum['Auth'] . "</td>";
                            echo "<td class='border-1'>" . $colum['Name'] . "</td>";
                            echo "<td class='border-1'>" . $colum['NameUser'] . "</td>";
                            echo "<td class='border-1'>" . $colum['Email'] . "</td>";
                            echo "<td class='border-1'>" . $colum['Password'] . "</td>";
                            echo "<td class='border-1'>" . $colum['Type'] . "</td>";
                            echo "<td class='border-1'>  <a href='../../html-forms/user-update? mat=" . $colum['ID'] . "'><button type='button' class='btn btn-success'> Modificar</button></a></td>";
                            echo "<td class='border-1'>  <a href='../../php-db/user-delete.php? mat=" . $colum['ID'] . "'><button type='button' class='btn btn-danger'> Eliminar</button></a></td>";
                            echo "<tr>";
                        }
