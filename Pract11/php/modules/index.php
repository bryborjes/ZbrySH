            ...
            <ul class="navbar-nav">
                ...
                <div class="menuSecionIniciada nav-item dropdown active">
                    ...
                    <div class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarDropdown" style="background-color: #00000085;">
                        ...
                        <a class="dropdown-item" href="">Modulos impartidos</a>
            ...
            <table class="text-center table w-100 border-black">
                <thead class="border-1 bg-info text-white" id="headtable">
                    <tr>
                        ...
                        <th class="border-1">Modulo</th>
                        <th class="border-1">Horas</th>
                        <th class="border-1">Creditos</th>
                        <th class="border-1" colspan="2">
                        <a href="../../html-forms/module-insert/" class="btn btn-light">Agregar nuevo</a>
                        </th>
                    </tr>
                </thead>
                <tbody class="bg-info-subtle">
                    ...
                    if (!$result) {
                        ...
                        while ($colum = mysqli_fetch_array($result)) {
                            echo "<tr>";
                            echo "<td class='border-1'>" . $colum['CodeModule'] . "</td>";
                            echo "<td class='border-1'>" . $colum['NameModule'] . "</td>";
                            echo "<td class='border-1'>" . $colum['Hours']."</td>";
                            echo "<td class='border-1'>" . $colum['Credits'] . "</td>";
                            echo "<td class='border-1'>  <a href='../../html-forms/module-update? mat=" . $colum['CodeModule'] . "'><button type='button' class='btn btn-success'> Modificar</button></a></td>";
                            echo "<td class='border-1'>  <a href='../../php-db/module-delete.php? mat=" . $colum['CodeModule'] . "'><button type='button' class='btn btn-danger'> Eliminar</button></a></td>";
                            echo "<tr>";
                        }
