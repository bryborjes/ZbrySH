            ...
            <table class="text-center table w-100 border-black">
                <thead class="border-1 bg-info text-white" id="headtable">
                    <tr>
                        ...
                        <a href="../../html-forms/teacher-insert/" class="btn btn-light">Agregar nuevo</a>
                        </th>
                    </tr>
                </thead>
                <tbody class="bg-info-subtle">
                    ...
                    if (!$result) {
                        ...
                        while ($colum = mysqli_fetch_array($result)) {
                            echo "<tr>";
                            echo "<td class='border-1'>" . $colum['IDteacher'] . "</td>";
                            echo "<td class='border-1'>" . $colum['Name'] . "</td>";
                            echo "<td class='border-1'>" . $colum['LastName'] . " " . $colum['MotherSurname'] . "</td>";
                            echo "<td class='border-1'>" . $colum['Adress'] . "</td>";
                            echo "<td class='border-1'>" . $colum['Email'] . "</td>";
                            echo "<td class='border-1'>" . $colum['Cellphone'] . "</td>";
                            echo "<td class='border-1'>  <a href='../../html-forms/teacher-update? mat=" . $colum['IDteacher'] . "'><button type='button' class='btn btn-success'> Modificar</button></a></td>";
                            echo "<td class='border-1'>  <a href='../../php-db/teacher-delete.php? mat=" . $colum['IDteacher'] . "'><button type='button' class='btn btn-danger'> Eliminar</button></a></td>";
                            echo "<tr>";
                        }
