            ...
            <ul class="navbar-nav">
                ...
                <div class="menuSecionIniciada nav-item dropdown active">
                    ...
                    <div class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarDropdown" style="background-color: #00000085;">
                        ...
                        <a class="dropdown-item" href="../teachers/">Maestros registrados</a>
                        <a class="dropdown-item" href="../modules/">Modulos impartidos</a>
                        <a class="dropdown-item" href="">Alumnos inscritos</a>
            ...
            <table class="text-center table w-100 border-black">
                <thead class="border-1 bg-info text-white" id="headtable">
                    <tr>
                        ...
                        <th class="border-1">Semestre</th>
                        <th class="border-1">Grupo</th>
                        <th class="border-1">Especialidad</th>
                        <th class="border-1" colspan="2">
                        <a href="../../html-forms/student-insert/" class="btn btn-light">Agregar nuevo</a>
                        </th>
                    </tr>
                </thead>
                <tbody class="bg-info-subtle">
                    ...
                    if (!$result) {
                        ...
                        while ($colum = mysqli_fetch_array($result)) {
                            echo "<tr>";
                            echo "<td class='border-1'>" . $colum['IDcontrol'] . "</td>";
                            echo "<td class='border-1'>" . $colum['Name'] . "</td>";
                            echo "<td class='border-1'>" . $colum['LastName'] . " " . $colum['MotherSurname'] . "</td>";
                            echo "<td class='border-1'>" . $colum['Semester'] . "</td>";
                            echo "<td class='border-1'>" . $colum['Cluster'] . "</td>";
                            echo "<td class='border-1'>" . $colum['Specialty'] . "</td>";
                            echo "<td class='border-1'>  <a href='../../html-forms/student-update? mat=" . $colum['IDcontrol'] . "'><button type='button' class='btn btn-success'> Modificar</button></a></td>";
                            echo "<td class='border-1'>  <a href='../../php-db/student-delete.php? mat=" . $colum['IDcontrol'] . "'><button type='button' class='btn btn-danger'> Eliminar</button></a></td>";
                            echo "<tr>";
                        }
